...
public class BeanUtil {
    ...
    private static final ConcurrentHashMap<Class, Field[]> fieldsCache = new ConcurrentHashMap<Class, Field[]>();
    ...
    public static String toString(Object obj) {
        ...
        String r = cl.getName();
        do {
            Field[] fields = fieldsCache.get(cl);
            if (null == fields) {
                fields = cl.getDeclaredFields();
                if (null != fields) {
                    AccessibleObject.setAccessible(fields, true);
                }
                fieldsCache.put(cl, fields);
            }
